...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.025726 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 257.26 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 115.885 seconds (Warm-up)
#> Chain 1:                108.562 seconds (Sampling)
#> Chain 1:                224.447 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'hmm' NOW (CHAIN 2).
#> Chain 2: 
#> Chain 2: Gradient evaluation took 0.017029 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 170.29 seconds.
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 115.114 seconds (Warm-up)
#> Chain 2:                101.762 seconds (Sampling)
#> Chain 2:                216.876 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'hmm' NOW (CHAIN 3).
#> Chain 3: 
#> Chain 3: Gradient evaluation took 0.017161 seconds
#> Chain 3: 1000 transitions using 10 leapfrog steps per transition would take 171.61 seconds.
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 113.062 seconds (Warm-up)
#> Chain 3:                118.21 seconds (Sampling)
#> Chain 3:                231.272 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'hmm' NOW (CHAIN 4).
#> Chain 4: 
#> Chain 4: Gradient evaluation took 0.016472 seconds
#> Chain 4: 1000 transitions using 10 leapfrog steps per transition would take 164.72 seconds.
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 120.86 seconds (Warm-up)
#> Chain 4:                119.308 seconds (Sampling)
#> Chain 4:                240.168 seconds (Total)
#> Chain 4: 
