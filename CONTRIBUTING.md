...
- Do not hand-edit generated files: `R/stanmodels.R`, `R/globals.R`,
  ...
  `.Rd`. `src/RcppExports.cpp` is generated by
  [`Rcpp::compileAttributes()`](https://rdrr.io/pkg/Rcpp/man/compileAttributes.html)
  and is tracked in git so direct GitHub installations
  (`devtools::install_github()`) succeed without requiring local code
  generation; synchronization is verified automatically by
  `just check-rcpp` and unit tests.
